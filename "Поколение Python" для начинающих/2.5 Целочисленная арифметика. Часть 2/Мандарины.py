'''
n школьников делят k мандаринов поровну, неделящийся остаток остается в корзине. Сколько целых мандаринов достанется каждому школьнику? 
...
students, mandarins = int(input()), int(input())
print(mandarins // students, mandarins % students, sep = "\n")
